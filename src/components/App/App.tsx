    ...
    <div className="App">
      ...
      <div id="model-select-container">
        ...
        <select id="model-select" value={modelValue} onChange={(event) => setModelValue(event.target.value as ModelValueType)}>
          <option value="chatgpt">GPT-3 (Understand and generate natural language )</option>
          <option value="gpt">Codex (Understand and generate code, including translating natural language to code)
          </option>
